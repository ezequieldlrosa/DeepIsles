...
1. Create an account on Grand Challenge ([https://grand-challenge.org/](https://grand-challenge.org/)) AND verify it ([instructions](grand-challenge.org/documentation/verification/) ). Please note that GC sends out a validation email that contains instructions how to successfully activate your account. 
